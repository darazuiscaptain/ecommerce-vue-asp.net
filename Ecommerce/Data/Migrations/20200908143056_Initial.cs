        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    screen_size = table.Column<decimal>(nullable: false),
                    talk_time = table.Column<decimal>(nullable: false),
                    standby_time = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_features", x => new { x.product_id, x.feature_id });
                    table.ForeignKey(
                        name: "fk_product_features_features_feature_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_variants", x => new { x.product_id, x.colour_id, x.storage_id });
                    table.ForeignKey(
                        name: "fk_product_variants_colours_colour_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_product_variants_storage_storage_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_features_feature_id",
                table: "product_features",
                column: "feature_id");

            migrationBuilder.CreateIndex(
                name: "ix_product_variants_colour_id",
                table: "product_variants",
                column: "colour_id");

            migrationBuilder.CreateIndex(
                name: "ix_product_variants_storage_id",
                table: "product_variants",
                column: "storage_id");
