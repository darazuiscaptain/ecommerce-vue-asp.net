<template>
    <form-input-base :label="label">
        <div class="multi-select">
            <input ref="input" :value="text" :name="name" :class="classes" @focus="focus" @blur="blur"
            ...
            <b-list-group v-if="open">
                <b-list-group-item v-for="(item, index) in items" :key="index" @mousedown.prevent="check(item)">

                    <b-form-checkbox class="checkbox" :checked="isChecked(item)" disabled>
